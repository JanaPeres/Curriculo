...
const Habilidades = ({ navigation }) => {
    return (
        <View style={estilo.container}>
            <View>
                <Text style={estilo.titulo}>Habilidades</Text>
            </View>

            <View style={estilo.textoContainer}>
                <Text style={estilo.texto}>
                Fiz curso em Excel, World, Datilografia, Fluxo de Caixa e Movimentação Bancária.
                </Text>
            ...
            <View style={estilo.botoes}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Experiencias')} style={estilo.botao}>
                    <Text style={estilo.textoBotao}>Experiências</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
